###################################################################
# Implementations from https://github.com/4uiiurz1/pytorch-adacos #
###################################################################
import torch
...
class AdaCos(nn.Module):
    def __init__(self, classnum, num_features=512, m=0.50):
    ...
    def forward(self, input, label=None):
        ...
        with torch.no_grad():
            ...
            self.s = torch.log(B_avg) / torch.cos(torch.min(math.pi /
                                                            4 * torch.ones_like(theta_med), theta_med))
